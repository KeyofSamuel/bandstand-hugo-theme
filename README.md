# Bandstand Hugo Theme

This theme is currently in BETA.  It does function but is not really polished.  Use at your own risk.  The documentation is in a very poor state.  It would be safer to disregard it at this point.  You've been warned.

...but come back here soon.  This should all get cleaned up shortly.

# About the Bandstand Theme
This theme was created specifically as a "rock band" website and press kit.

# Everything from this point down is just unsorted, jumbled notes.

All images should be 96 DPI

## Custom CSS
Placed in the assets/css directory and listed in the config.toml

## Fonts
Fonts are set in the head.html and use Google Roboto Slab and Rubik by default.  Fonts are assigned in the main.css file. To change, call a different font in the head.html and then update the main.css as necessary.

## Header
Set the site header logo in config file
Set the header menu in the config file

## Hero
Set the hero image in the config file

## About secton
Update the title and description in the config file
